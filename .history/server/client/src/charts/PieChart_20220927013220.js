...
function PieChart() {
    ...
    var data = {
        ...
        datasets: [{
            label: '# of Votes',
            data: [chartData.FDSS, chartData.US, chartData.FSN, chartData.MCSS, chartData.PGSS],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
    ...
    return (
        <>
        <h6 className='uppercase text-xs text-center font-medium pb-4'>Total Number of Customers per Month</h6>

...
function BarChart() {
    ...
    const data = {//purchases made
        ...
        datasets: [{
            ...
            data: [chartData.jan, chartData.feb, chartData.mar, chartData.apr, chartData.may, chartData.jun, chartData.jul, chartData.aug, chartData.sept, chartData.oct, chartData.nov, 0],
            backgroundColor: [
                'rgba(255, 159, 64, 0.2)'
            ],
            borderColor: [

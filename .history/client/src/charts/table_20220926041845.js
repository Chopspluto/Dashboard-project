...
function Table({ setClicked }) {
    ...
    useEffect(() => {
        setClicked(true) ? getUsersbyLocation() : getUsers();
    },[])
                ...
                <tbody>
                    {
                        userData.map((getData) => (
                            <tr key={setClicked(true) ? getDataLocation.user_id : getDataLocation.user_id}>
                                <td>{setClicked(true) ? getDataLocation.user_id : getDataLocation.user_id}</td>

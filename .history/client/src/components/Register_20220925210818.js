        ...
        <>
            <div className='main_container'>
                <form onSubmit={onSubmitForm}>
                    ...
                    <input type='text' name='location' placeholder='Enter your location' value={location} onChange={e => onChange(e)} />
                    <input type='text' name='date' placeholder='YYYY/MM/DD' value={order_date} onChange={e => onChange(e)} />

...
function Register({ setAuth }) {
    ...
    // 
    const { name, email, password, location, order_date } = inputs;
    // 
    const onChange = (e) => {
    ...
    const onSubmitForm = async (e) => {
        e.preventDefault();
        try {
            const body = { name, email, password, location, order_date };
        ...
        <>
            <div className='main_container'>
                <form onSubmit={onSubmitForm}>
                    ...
                    <input type='text' name='location' placeholder='Enter your password' value={password} onChange={e => onChange(e)} />
                    <input type='text' name='password' placeholder='Enter your password' value={password} onChange={e => onChange(e)} />

...
function Register({ setAuth }) {
    ...
    // 
    const { name, email, password, location, product_1, product_1_price, product_2, product_2_price, product_3, product_3_price, order_date } = inputs;
    // 
    const onChange = (e) => {
    ...
    const onSubmitForm = async (e) => {
        e.preventDefault();
        try {
            const body = { name, email, password, location, product_1, product_1_price, product_2, product_2_price, product_3, product_3_price, order_date };

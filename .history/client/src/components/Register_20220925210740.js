        ...
        <>
            <div className='main_container'>
                <form onSubmit={onSubmitForm}>
                    ...
                    <input type='text' name='location' placeholder='Enter your location' value={password} onChange={e => onChange(e)} />
                    <input type='text' name='date' placeholder='Enter your password' value={password} onChange={e => onChange(e)} />
